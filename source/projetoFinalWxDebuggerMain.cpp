...
projetoFinalWxDebuggerFrame::projetoFinalWxDebuggerFrame(wxWindow* parent,wxWindowID id)
{
    ...
    cbxAmort->Append(_("Não aplicável"));
    ...
    txtParam1->SetToolTip(_("Uniforme: valor mínimo / Normal: média"));
    ...
    txtParam2->SetToolTip(_("Uniforme: valor médio ou realista /  Normal: desvio padrão"));
    ...
    txtParam3->SetToolTip(_("Uniforme: valor máximo / Normal: não aplicável"));
    ...
    bxAEF = new wxStaticBox(this, ID_STATICBOX4, _("Avaliação Econômico-Financeira"), wxPoint(520,24), wxSize(480,240), 0, _T("ID_STATICBOX4"));
    ...
    lblValorIndEcon = new wxStaticText(this, ID_STATICTEXT16, _("Valor indicador econômico (%/ano):"), wxPoint(536,144), wxDefaultSize, 0, _T("ID_STATICTEXT16"));
    ...
    bxSMC = new wxStaticBox(this, ID_STATICBOX5, _("Simulação de Monte Carlo"), wxPoint(520,280), wxSize(480,248), 0, _T("ID_STATICBOX5"));
    ...
    lblTir->SetToolTip(_("TIR ou Taxa Interna de Rentabilidade é a taxa de atualização do projeto que dá o VPL nulo. Deve ser comparada com a Taxa Mínima de Atratividade - TMA do adquirente.\n\nPara esta análise a TMA é equivalente à taxa de custo de oportunidade.\n\nSe a TIR for mais que a TMA o projeto é considerado vantajoso."));
    ...
    lblPaybackDescontado->SetToolTip(_("Payback refere-se ao tempo que um investimento leva para pagar o seu investimento inicial.\n\nNo método descontado emprega-se uma taxa de desconto antes de se proceder à soma dos fluxos de caixa.  Neste caso é empregado a taxa informada no campo do valor do indicador econômico.\n\nQuanto menor for este prazo melhor!"));
    lblVpl = new wxStaticText(this, ID_STATICTEXT28, _("VPL (R$):"), wxPoint(1304,344), wxDefaultSize, 0, _T("ID_STATICTEXT28"));
    lblVpl->SetToolTip(_("VPL ou Valor Presente Líquido é a fórmula financeira capaz de determinar o valor presente de pagamentos futuros descontados a uma taxa de interessa apropriada, menos o custo do investimento inicial. \n\nA taxa emprega neste caso é a taxa de custo de oportunidade.\n\nSe o VPL for mais que zero o projeto é vantajoso!"));
    lblRcb = new wxStaticText(this, ID_STATICTEXT29, _("Razão custo/benefício:"), wxPoint(1304,376), wxDefaultSize, 0, _T("ID_STATICTEXT29"));
    lblRcb->SetToolTip(_("A relação de custo-beneficio é um indicador que relaciona os benefícios de um projeto ou proposta, expressos em termos monetários, e o seus custos, também expressos em termos monetários. \n\nTanto os benefícios como os custos devem ser expressos em valores presentes. \n\nEm regra geral, se essa relação é > 1 o projeto é considerado vantajoso.\n\n"));
    lblExpAvef = new wxStaticText(this, ID_STATICTEXT30, _("Premissas:\n1 - São considerados os valores cadastrados nos campos valor, ou seja não se considera a distribuição de dispersão para estes cálculos;\n2 - O período total de analise (n) é sempre acrescido de 2, referentes ao desembolso inicial (t=n-1) e o retorno final do investimento (t=n+1);\n3 - O valor do imóveil é ajustado pela taxa do indicador econômico para o último período da análise como uma receita.\n\n"), wxPoint(1296,400), wxSize(328,120), wxST_NO_AUTORESIZE|wxNO_BORDER|wxVSCROLL|wxALWAYS_SHOW_SB, _T("ID_STATICTEXT30"));
    ...
    txtRcb->Disable();
    lblPeriodo = new wxStaticText(this, ID_STATICTEXT31, _("Periodo de análise:"), wxPoint(536,240), wxDefaultSize, 0, _T("ID_STATICTEXT31"));
...
void projetoFinalWxDebuggerFrame::OnAbout(wxCommandEvent& event)
{
    ...
    wxMessageBox(msg, _("Sistema para Simulação de Monte Carlo."));
}
    ...
    if (dados.isErro()){
        ...
        viewFacade.executar();
         if (dados.isErro()){
            ...
            s << "Execução concluída em " << elapsed_secs << " segundos!";
            wxMessageBox(s.str(), _("Informação"));
        }
    }
